  ...
  <div class="latest campaign">
	<div class="container">
     ...
     <div class="campaign-item">
          <a class="overlay" href="campaign//creation d'une site de vente en ligne">
              <img title="Creation d'une site de vente en ligne" src="public/campaigns/small/11031696260974vyxmwghjwdvwjnb8w0p7tul07ujo1tyzaprbxptd.jpeg" alt="">
              <span class="ion-ios-search-strong"></span>
          </a>
          <div class="campaign-box">
              <a href="listCampaign/business" class="category">business</a>
              <h3><a href="campaign/856/creation d'une site de vente en ligne">creation site de vente en ligne</a></h3>
              <div class="campaign-description">Le but est de creer une site de vente en ligne pour femmes</div>
              <div class="campaign-author">
                <a class="author-icon" href= <img src= "{{url('img/roman.jpeg')}}" alt="" class="d-block w-100"> </a> <a class="author-name" href="void:javascript(0)">Malaw</a></div>
              <div class="process">
                  ...
                  <div class="process-info">
                      <div class="process-pledged" style="width: 45%"><span style="margin-right: 0 !important;">100000 FCFA</span> But</div>
                      <div class="process-funded" style="width: 45%"><span style="margin-right: 0 !important;">00 FCFA</span> Recueillis</div>
