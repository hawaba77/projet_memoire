  ...
  <div class="latest campaign">
	<div class="container">
     ...
     <div class="campaign-item">
          <a class="overlay" href="campaign//Transformation cereales">
              <img title="transformation cereales" src="public/campaigns/small/11031696260974vyxmwghjwdvwjnb8w0p7tul07ujo1tyzaprbxptd.jpeg" alt="">
              <span class="ion-ios-search-strong"></span>
          </a>
          <div class="campaign-box">
              <a href="listCampaign/agriculture" class="category">agriculture</a>
              <h3><a href="campaign/856/transformation cereales">Transformation cereales</a></h3>
              <div class="campaign-description">Jeunes diplômés nous souhaitons une aide pour développer l'entreprise que l'on a créé et faire l'impossible pour le hausser de l'avant pour cela votre aide est très précieux</div>
              <div class="campaign-author">
                <a class="author-icon" href= <img src= "{{url('img/roman.jpeg')}}" alt="" class="d-block w-100"> </a> <a class="author-name" href="void:javascript(0)">Aissata</a></div>
              <div class="process">
                  ...
                  <div class="process-info">
                      <div class="process-pledged" style="width: 45%"><span style="margin-right: 0 !important;">500000FCFA</span> But</div>
                      <div class="process-funded" style="width: 45%"><span style="margin-right: 0 !important;">40000 FCFA</span> Recueillis</div>
